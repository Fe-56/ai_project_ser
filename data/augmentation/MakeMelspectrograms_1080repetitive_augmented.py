...
def main():
    ...
    # We only want to augment the train set
    ...
    if SAVE_CSV:
        ...
        train.to_csv('melspectrogram_train_dataset_augmented.csv', index=False)
    ...
    print(f"Results saved to melspectrogram_train_dataset_augmented.csv")
